---
name: sage_architecture_and_foundation
description: Guides the design, architectural style (Modular Monolith), component layout, and technology stack selection for the SAGE project.
---
