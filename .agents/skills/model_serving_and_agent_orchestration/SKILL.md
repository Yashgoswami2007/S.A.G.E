---
name: sage_model_serving_and_agent_orchestration
description: Guides model serving setup (vLLM / llama.cpp), model routing classification logic, custom ReAct agent loop orchestration, and coding agent profile.
---
